...
result_df.rename(columns={'TRADEDATE': 'trade_date', 'SYMBOL': 'stock_code'}, inplace=True)
result_df = result_df[['stock_code', 'trade_date', 'ma_5_days_signal', 'ma_10_days_signal', 'ma_20_days_signal',
                       'ma_30_days_signal']]
