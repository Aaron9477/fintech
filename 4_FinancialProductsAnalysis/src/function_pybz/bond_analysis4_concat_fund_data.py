...
def concat_top10_date_and_output(fund_df_input, bond_df_input, writer):
    ...
    output_df.rename(columns={'基金名称': '产品名称', '基金类型': '产品一级类型', '基金二级分类': '基金:产品二级类型 / 债券:久期',
                              '基金资产规模': '资产规模', '基金占公司基金总规模之比': '资产占公司该类型资产总规模之比',
                              '排名': '规模排名', '一年收益率': '基金:一年收益率 / 债券:债券评级', '二级分类下量化打分': '基金:二级分类下量化打分 / 债券:空',
                              '二级分类下量化打分排名': '基金:二级分类下量化打分排名 / 债券:主体地区'}, inplace=True)
    output_df['大类资产类型'] = '基金'

    # 债券会故意将信息放在错误的列名下，方便后续excel匹配使用
    # 久期 - 基金:产品二级类型 / 债券；债券资产规模 - 资产规模；债券占公司债券总规模之比 - 资产占公司该类型资产总规模之比
    # 债券评级 - 基金:一年收益率 / 债券:债券评级；主体地区 - 基金:二级分类下量化打分排名 / 债券:主体地区
    bond_type_df = bond_df['各债券类型前十大']
    bond_type_df = bond_type_df[['理财子公司', '债券类型', '债券名称_代码', '久期', '债券评级', '主体地区', '债券资产规模', '债券占公司债券总规模之比', '排名']]
    bond_type_df.rename(columns={'债券类型': '产品一级类型', '债券名称_代码': '产品名称', '久期': '基金:产品二级类型 / 债券:久期', '债券资产规模': '资产规模',
                                 '债券占公司债券总规模之比': '资产占公司该类型资产总规模之比', '债券评级': '基金:一年收益率 / 债券:债券评级',
                                 '主体地区': '基金:二级分类下量化打分排名 / 债券:主体地区', '排名': '规模排名'}, inplace=True)
    bond_type_df['大类资产类型'] = '债券(按评级)'
    ...
    bond_urban_investment_df = bond_urban_investment_df[['理财子公司', '债券名称_代码', '久期', '债券评级', '主体地区', '债券资产规模', '债券占公司债券总规模之比', '排名']]
    bond_urban_investment_df.rename(columns={'债券类型': '产品一级类型', '债券名称_代码': '产品名称', '久期': '基金:产品二级类型 / 债券:久期', '债券资产规模': '资产规模',
                                 '债券占公司债券总规模之比': '资产占公司该类型资产总规模之比', '债券评级': '基金:一年收益率 / 债券:债券评级',
                                 '主体地区': '基金:二级分类下量化打分排名 / 债券:主体地区', '排名': '规模排名'}, inplace=True)
    bond_urban_investment_df['大类资产类型'] = '债券(按类型)'
    ...
    bond_subordinated_df = bond_subordinated_df[['理财子公司', '债券名称_代码', '久期', '债券评级', '主体地区', '债券资产规模', '债券占公司债券总规模之比', '排名']]
    bond_subordinated_df.rename(columns={'债券类型': '产品一级类型', '债券名称_代码': '产品名称', '久期': '基金:产品二级类型 / 债券:久期', '债券资产规模': '资产规模',
                                 '债券占公司债券总规模之比': '资产占公司该类型资产总规模之比', '债券评级': '基金:一年收益率 / 债券:债券评级',
                                 '主体地区': '基金:二级分类下量化打分排名 / 债券:主体地区', '排名': '规模排名'}, inplace=True)
    bond_subordinated_df['大类资产类型'] = '债券(按类型)'
    ...
    bond_perpetual_df = bond_perpetual_df[['理财子公司', '债券名称_代码', '久期', '债券评级', '主体地区', '债券资产规模', '债券占公司债券总规模之比', '排名']]
    bond_perpetual_df.rename(columns={'债券类型': '产品一级类型', '债券名称_代码': '产品名称', '久期': '基金:产品二级类型 / 债券:久期', '债券资产规模': '资产规模',
                                 '债券占公司债券总规模之比': '资产占公司该类型资产总规模之比', '债券评级': '基金:一年收益率 / 债券:债券评级',
                                 '主体地区': '基金:二级分类下量化打分排名 / 债券:主体地区', '排名': '规模排名'}, inplace=True)
    bond_perpetual_df['大类资产类型'] = '债券(按类型)'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fund_file', type=str, help='fund_file', default='理财子重仓基金分析.xlsx')
    parser.add_argument('--bond_file', type=str, help='bond_file', default='理财子重仓债券分析.xlsx')
