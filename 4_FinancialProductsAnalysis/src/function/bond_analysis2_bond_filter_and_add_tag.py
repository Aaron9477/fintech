...
if __name__ == '__main__':
    ...
    parser.add_argument('--investment_details_file', type=str, help='investment_details_file', default='../data/金融产品投资组合明细_22年三季报_230105_手动修改.csv')
    ...
    investment_details_df = pd.read_csv(investment_details_file)
