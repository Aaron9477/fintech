...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, help='input_file', default='债券信息_23年12月.xlsx')
    parser.add_argument('--output_file', type=str, help='output_file', default='统计债券占比_23年12月.xlsx')
