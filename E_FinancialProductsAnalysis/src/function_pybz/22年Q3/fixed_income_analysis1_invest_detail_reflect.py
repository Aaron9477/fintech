...
if __name__ == '__main__':
    ...
    parser.add_argument('--top10_fix_income_enhance_analysis_file', type=str, help='top10_fix_income_enhance_analysis_file', default='../data_pybz/pybz_金融产品前十名持仓_22年三季报_230314.csv')
