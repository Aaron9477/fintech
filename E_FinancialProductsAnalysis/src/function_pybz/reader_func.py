...
def get_raw_files(statistics_date):
    if statistics_date == '2022-06-30':
        ...
        raw_asset_file = '../../data_pybz/pybz_金融产品资产配置_22年四季报_230515.csv'
        top10_file = '../../data_pybz/pybz_金融产品前十名持仓_22年四季报_230515.csv'
        non_standard_file = '../../data_pybz/pybz_非标准化债权及股权类资产表_22年四季报_230515.csv'
