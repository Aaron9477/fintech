...
def get_trading_day(statistics_date):
    if statistics_date == '2022-09-30':
        ...
        trading_day = '2024-06-28'
    elif statistics_date == '2024-09-30':
        trading_day = '2024-09-30'
    elif statistics_date == '2024-12-31':
        trading_day = '2024-12-31'
    else:
        raise ValueError
    return trading_day
...
if __name__ == '__main__':
    ...
    elif args.statistics_date == '2023-12-31':
    ...
    company_fund_rank_add_company_asset.rename(columns={'基金一级分类': 'wind一级分类', '基金二级分类': 'wind二级分类', '理财子公司': '理财公司',
                                                        ...
                                                        '一年收益率': '基金近一年收益率(截至季度末)', '二级分类下量化打分': '基金评估中心二级分类下量化打分',
    ...
    final_df = company_fund_rank_add_company_asset[['基金名称', '基金代码', 'wind一级分类', 'wind二级分类', '基金公司', '理财公司', '持有基金市值（万元）', '理财公司投资基金总规模（万元）',
                   ...
                   '基金近一年收益率(截至季度末)', '基金评估中心二级分类下量化打分', '二级分类下量化打分排名']]
