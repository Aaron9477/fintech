...
def choose_report_220630(input_df):
...
def choose_report_220930(input_df):
    # 按 2022中报、2022二季报 的顺序，选取一份报告做后续处理
    input_df = input_df[(input_df['InfoSource'] == '2022三季报')]
    return input_df
...
def cal_asset_num(input_df):
    # 前处理
    # input_df = choose_report_220630(input_df)
    input_df = choose_report_220930(input_df)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, help='input_file', default='../data/金融产品投资组合明细_22年三季报_221222.csv')
    ...
    # 前处理
    df = df_preprocess(df, all_data_df)
