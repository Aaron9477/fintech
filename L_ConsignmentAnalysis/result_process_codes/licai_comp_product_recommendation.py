...
def licai_comp_product_recommendation(start_date,end_date,df1,df2,df7,df9,result_type='single'):
    ...
    for timerange in ['近一年','近半年','近三月']:
        ...
        while date >= start_date:
            ...
            df1_temp['二级分类'] = df1_temp[['固收增强分类_补充子产品','product_type_son']].apply(func4,axis=1)#新生成一列二级分类，综合使用之前的两列数据
            ...
            field_care = ['RegistrationCode','FinProCode','product_name','理财公司简称',
                          ...
                          '夏普比率','最大回撤',timerange+'收益','收益排名']
            底层数据_产品甄选_理财公司_temp1 = df5_temp[field_care].groupby(['理财公司简称','InvestmentType','open_type','持有期限'])
            底层数据_产品甄选_理财公司_temp11 = df5_temp[field_care].groupby(['理财公司简称','InvestmentType','持有期限'])
            底层数据_产品甄选_理财公司_temp12 = df5_temp[field_care].groupby(['理财公司简称','InvestmentType','open_type'])
            底层数据_产品甄选_理财公司_temp13 = df5_temp[field_care].groupby(['理财公司简称','InvestmentType'])
            #甄选每家的前10名
            ...
            field_care = ['RegistrationCode','FinProCode','product_name','理财公司简称',
                          ...
                          'AssetValue','BenchmarkMin','RiskLevel','manage_fee',
                          '夏普比率','最大回撤',timerange+'收益','收益排名']
            底层数据_产品甄选_理财公司_temp2 = df6_temp[field_care].groupby(['理财公司简称','InvestmentType','open_type','持有期限'])
            底层数据_产品甄选_理财公司_temp21 = df6_temp[field_care].groupby(['理财公司简称','InvestmentType','持有期限'])
            底层数据_产品甄选_理财公司_temp22 = df6_temp[field_care].groupby(['理财公司简称','InvestmentType','open_type'])
            底层数据_产品甄选_理财公司_temp23 = df6_temp[field_care].groupby(['理财公司简称','InvestmentType'])
            #甄选每家的前五名
            ...
            i= i+1
        底层数据_产品甄选_理财公司 = 底层数据_产品甄选_理财公司.fillna("-")
    ...
    return 底层数据_产品甄选_理财公司_近一年,底层数据_产品甄选_理财公司_近半年,底层数据_产品甄选_理财公司_近三月