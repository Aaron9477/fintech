...
def licai_comp_product_shelves_paint(start_date, end_date, df1, df2, result_type='single'):
    '''
    function:生成【底层数据_代销产品货架_理财公司】依赖表
    params:
        ...
        - result_type:str,数据生成的报表类型，取值有'single'(代表单个公司数据)，'licai_sector'(理财公司分版块),'daixiao_sector'(代销公司分版块)，'sector'(理财公司和理财公司都分版块)。
    return:
        - 底层数据_代销产品货架_理财公司:【底层数据_代销产品货架_理财公司】依赖表，用于更新理财图鉴。
    '''
    print(" *生成【底层数据_代销产品货架_理财公司_绘图】依赖表, ", start_date, "到", end_date, "...")
    ...
    Investment_type_ts_n = Investment_type_ts_n.pivot(
        index=['发行机构', '日期'], columns='InvestmentType')
    ...
    MinInvestTimeType_ts_n = MinInvestTimeType_ts_n.pivot(
        index=['发行机构', '日期'], columns='MinInvestTimeType')
    ...
    底层数据_代销产品货架_理财公司_绘图_n = pd.concat(
        [Investment_type_ts_n, MinInvestTimeType_ts_n], axis=1)

    底层数据_代销产品货架_理财公司_绘图_n.columns = 底层数据_代销产品货架_理财公司_绘图_n.columns.droplevel(None)
    底层数据_代销产品货架_理财公司_绘图_n.rename(columns={'固定收益类': '固收非现金', '封闭短期': '封闭短期（一年内）', '封闭中期': '封闭中期（一年到三年）', '封闭长期': '封闭长期（三年以上）', '封闭长期': '封闭长期（三年以上）',
                                        '开放短期': '开放短期（一个月内）', '开放短中期': '开放短中期（一月到三月）', '开放中期': '开放中期（三月到半年）', '开放中长期': '开放中长期（半年到一年）', '开放长期': '开放长期（一年以上）'}, inplace=True)

    底层数据_代销产品货架_理财公司_绘图_n = 底层数据_代销产品货架_理财公司_绘图_n.loc[:,
                                                  ["现金管理类", "固收非现金", "混合类", "权益类", "商品及金融衍生品类",'封闭短期（一年内）', '封闭中期（一年到三年）', '封闭长期（三年以上）', '开放短期（一个月内）', '开放短中期（一月到三月）', '开放中期（三月到半年）', '开放中长期（半年到一年）', '开放长期（一年以上）']]

    底层数据_代销产品货架_理财公司_绘图_y =pd.concat(
        [Investment_type_ts_y, MinInvestTimeType_ts_y], axis=1) 

    底层数据_代销产品货架_理财公司_绘图_y.columns = 底层数据_代销产品货架_理财公司_绘图_y.columns.droplevel(None)
    底层数据_代销产品货架_理财公司_绘图_y.rename(columns={'固定收益类': '固收非现金', '封闭短期': '封闭短期（一年内）', '封闭中期': '封闭中期（一年到三年）', '封闭长期': '封闭长期（三年以上）', '封闭长期': '封闭长期（三年以上）',
                                        '开放短期': '开放短期（一个月内）', '开放短中期': '开放短中期（一月到三月）', '开放中期': '开放中期（三月到半年）', '开放中长期': '开放中长期（半年到一年）', '开放长期': '开放长期（一年以上）'}, inplace=True)
    if "权益类" not in 底层数据_代销产品货架_理财公司_绘图_y.columns:
        底层数据_代销产品货架_理财公司_绘图_y["权益类"]=np.nan
    底层数据_代销产品货架_理财公司_绘图_y = 底层数据_代销产品货架_理财公司_绘图_y.loc[:,
                                                  ["现金管理类", "固收非现金", "混合类", "权益类", "商品及金融衍生品类",'封闭短期（一年内）', '封闭中期（一年到三年）', '封闭长期（三年以上）', '开放短期（一个月内）', '开放短中期（一月到三月）', '开放中期（三月到半年）', '开放中长期（半年到一年）', '开放长期（一年以上）']]

    底层数据_代销产品货架_理财公司=pd.concat([底层数据_代销产品货架_理财公司_绘图_n,底层数据_代销产品货架_理财公司_绘图_y],keys=['否','是'],names=['是否剔除母子关系'],axis=1)
    # 一些处理
