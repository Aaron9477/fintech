...
def get_data_tmp(begin_date, end_date):
    base_data = BaseData()
    base_data_obj = GetBaseData(base_data)
    ...
    bond_fund_strategy_df = fund_strategy_df[(fund_strategy_df['first_strategy'] == 1001) & ((fund_strategy_df['second_strategy'] == 100101) |
                                                                                             (fund_strategy_df['second_strategy'] == 100102) |
                                                                                             (fund_strategy_df['second_strategy'] == 100103))]
    ...
    bond_name_df = bond_name_df[["fund_id", "fund_name", "fund_short_name", "advisor_id"]]
...
if __name__ == '__main__':
    ...
    # print(updata_data)
    updata_data.to_excel('股多私募产品明细.xlsx')
